...
def run(weights=ROOT / 'yolov5n.pt',  # model.pt path(s)
        ...
        view_img=False,  # show results# YOLOv5 🚀 by Ultralytics, GPL-3.0 license
"""
Run inference on images, videos, directories, streams, etc.
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    #print(round((c1[0]+c2[0])/2),round((c1[1]+c2[1])/2)) #coordinates
                    ...
                    for c in det[:, -1].unique(): 
                        ...
                        #elif(g == "bucket "): #bucket detection. need to pick out specific color and change camera direction
                            #if round((c1[0]+c2[0])/2) > 340:
                                #RIGHT_TURN(1,2,3)
                            #else:
                                #if round((c1[0]+c2[0])/2) < 300 :
            ...
            #print(int(xyxy[0]))
            #print(int(xyxy[0])) #see middle coordinates
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    for c in det[:, -1].unique():
                        ...
                        #pid code for every iteration
                        err2 = 5
                        err_last=0
                        for _ in range(4):
                            
                            err=PID(err2, err_last, 2,0.2,2,3)
                            #print(err[0]) #print PID_value
                            #print(err_now)
